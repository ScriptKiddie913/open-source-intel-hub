...
// API endpoints for abuse.ch services and additional threat sources
const ENDPOINTS = {
  ...
  ransomwareGroups: 'https://raw.githubusercontent.com/joshhighet/ransomwatch/main/posts.json',
  cisa_kev: 'https://www.cisa.gov/sites/default/files/feeds/known_exploited_vulnerabilities.json',
  // More sources will be added via comprehensive aggregator
};
